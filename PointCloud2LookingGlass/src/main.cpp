...
void usage() {
    ...
    printf("-v, --video [PATH]\t\tTo play video\n");
    printf("-c, --camera\t\t\tShow live signal from camera (Developing...)\n");
...
int main(int argc, char* argv[]) {
    ...
    if (argc == 1) {
        ...
        else if (strcmp(argv[1], "-c") == 0 || strcmp(argv[1], "--camera") == 0)        cameraHandler::cameraHandler();
        else if (strcmp(argv[1], "-v") == 0 || strcmp(argv[1], "--video") == 0)        vtkHandler::vtkHandler(argv);
        else { 
